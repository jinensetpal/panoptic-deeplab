...
def get_metrics(): # wrapper function
    return {'mIoU': tf.keras.metrics.MeanIoU(const.N_CLASSES, 'IoU'),
            'PQ': PanopticQuality(const.N_CLASSES, 0, const.MAX_INSTANCE_PER_CATEGORY, 0),
            'AP': PanopticInstanceAveragePrecision(const.N_CLASSES, [], const.PANOPTIC_LABEL_DIVISOR, 0)}
